...
pub fn is_coupon_date(date: NaiveDate, bond: BondState) -> bool {
    if bond.archetype.frequency_per_year == 0 {
        return false;
    }
    ...
    date.day() == bond.issue_date.day()
        ...
        && months_since_issue % (12 / bond.archetype.frequency_per_year) == 0
}
