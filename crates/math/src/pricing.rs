...
mod tests {
    ...
    fn test_ytm_calculation() {
        ...
        let ytm = ytm_bond(price, face_value, coupon_rate, years, frequency);
    ...
    fn test_bond_price_calculation() {
        ...
        let price = bond_price(face_value, coupon_rate, ytm, years, frequency);
    ...
    fn test_duration_calculation() {
        ...
        let dur = duration(face_value, coupon_rate, ytm, years, frequency);
